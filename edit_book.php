...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE buku SET 
            judul = '$judul',
            penulis = '$penulis',
            rekomendasi_usia = '$rekomendasi_usia',
            cover = '$cover',
            deskripsi = '$deskripsi',
            stok = '$stok'
            WHERE id = '$id'";
                        ...
                        <?php if($book): ?>
                            <form method="POST" action="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="penulis" value="<?php echo $book['penulis']; ?>" required>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Rekomendasi Usia</label>
                                    <input type="number" class="form-control" name="rekomendasi_usia" value="<?php echo $book['rekomendasi_usia']; ?>">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">URL Cover</label>
                                    <input type="text" class="form-control" name="cover" value="<?php echo $book['cover']; ?>">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Deskripsi</label>
                                    <textarea class="form-control" name="deskripsi" rows="3"><?php echo $book['deskripsi']; ?></textarea>
                                </div>
